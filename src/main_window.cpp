...
{
	Project::Project* project = Project::Project::load(filePath);
...
void MainWindow::closeProjectTabs(Project::Project *project)
{
	QList<Tab *> all = tabs();
	int i = 0;
...
Project::Project* MainWindow::activeProject() const
{
