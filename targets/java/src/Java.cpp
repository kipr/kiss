...
void Java::setLexerSpecs()
{
	...
	m_lexerSpec.keywords[1] = "asm auto break case char final continue default do "
		"double else enum extern float for goto if int long "
		"return short extends class static implements "
		"switch void while public protected private";
}
