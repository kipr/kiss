...
**
** Created: Fri Feb 18 14:12:46 2011
...
static const char qt_meta_stringdata_SerialClient[] = {
    "SerialClient\0"
};

const QMetaObject SerialClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialClient,
      qt_meta_data_SerialClient, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SerialClient::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SerialClient))
