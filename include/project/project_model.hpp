...
namespace kiss
{
	...
	{	
      ...
      const QModelIndex indexFromFile(const QString &filePath, const kiss::project::ProjectPtr &project) const;
      const QModelIndex indexFromProject(const kiss::project::ProjectPtr &project) const;
