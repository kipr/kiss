...
CppLexerSpecProvider::CppLexerSpecProvider() : LexerSpecProvider("cpp hpp h")
{
	
}

void CppLexerSpecProvider::init()
{
	...
	m_lexerSpec.keywords[1] = "asm auto break case char const continue default do "
		...
		"class public private protected new delete delete[]";
...
Q_EXPORT_PLUGIN2(cpp_plugin, CppLexerSpecProvider);