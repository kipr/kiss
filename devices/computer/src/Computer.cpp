...
const bool Computer::run(const QString& name)
{
...
CompilationPtr Computer::compile(const QString& name)
{
...
const bool Computer::download(const QString& name, TinyArchive *archive)
{
