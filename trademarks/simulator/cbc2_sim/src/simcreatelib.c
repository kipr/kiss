...
int create_cliffs() {
	gc_lcliff_amt=robot.cliffs[3];
	gc_lfcliff_amt=robot.cliffs[2];
	gc_rfcliff_amt=robot.cliffs[1];
	gc_rcliff_amt=robot.cliffs[0];
	gc_lcliff=(robot.cliffs[3]<20)?1:0;
	gc_lfcliff=(robot.cliffs[2]<20)?1:0;
	gc_rfcliff=(robot.cliffs[1]<20)?1:0;
	gc_rcliff=(robot.cliffs[0]<20)?1:0;
	return(0);
}
